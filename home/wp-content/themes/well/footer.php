...
<footer id="mac-footer" class="maroon" style="background:#7a003c;">
    ...
    <ul id="mcmaster--links">
        ...
        <li><a style="color:#FFF" href="https://www.mcmaster.ca/privacy/">Privacy Policy</a></li>
    </ul>
    <ul id="social--links">
        <li class="instagram"><a href="https://www.instagram.com/mcmasteru" target="_blank">
            <svg id="social-instagram" class="social" title="" alt="McMaster Instagram" style="max-width:20px; height:28px; fill: #fff" xmlns="https://www.w3.org/2000/svg" width="17.14" height="17.14" viewBox="0 0 17.14 17.14">
        ...
        <li class="twitter twitter-x"><a href="https://www.x.com/mcmasteru" target="_blank">
            <svg id="social-x" class="social" title="" alt="McMaster X" style="max-width:20px; height:28px; fill: #fff" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/>
            </svg>
        </a></li>
        <li class="facebook"><a href="https://www.facebook.com/mcmasteruniversity" target="_blank">
            <svg id="social-facebook" class="social" title="" alt="McMaster Facebook" style="max-width:20px; height:28px; fill: #fff" xmlns="https://www.w3.org/2000/svg" width="9.64" height="18.57" viewBox="0 0 9.64 18.57">
        ...
        <li class="youtube"><a href="https://www.youtube.com/mcmasterutv" target="_blank" class="color:#FFF">
            <svg id="social-youtube" class="social" title="" alt="McMaster YouTube" style="max-width:18px; height:28px; fill: #fff" xmlns="https://www.w3.org/2000/svg" width="20" height="14.06" viewBox="0 0 20 14.06">
        ...
        <li class="linkedin"><a href="https://www.linkedin.com/school/164897/" target="_blank">
            <svg id="social-linkedin" class="social" alt="McMaster LinkedIn" style="max-width:16px; height:28px; fill: #fff" title="" xmlns="https://www.w3.org/2000/svg" width="17.14" height="16.38" viewBox="0 0 17.14 16.38">
