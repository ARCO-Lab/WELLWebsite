...
, function(c, e, t) {
    ...
    window.footerheader = (function() {
        ...
        return (n(c, [{
            ...
            key: "getChevron",
            value: function() {
                return (this.chevron = '<svg id="chevron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6.7 4.1"><style>.st0{fill:none;stroke:#FFFFFF;stroke-miterlimit:10;}</style><path class="st0" d="M6.4.4l-3 3-3-3"/></svg>');
            },
        }, {
            key: "initGoogleCSS",
            value: function() {
