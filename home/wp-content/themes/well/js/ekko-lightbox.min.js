          ...
          , g = function() {
            ...
            c(d, [{
                ...
                value: function() {
                    ...
                    if (["image", "youtube", "vimeo", "instagram", "media", "url"].indexOf(c) < 0)
                ...
                value: function(a, b) {
                    ...
                    return this._showVideoIframe("//www.youtube-nocookie.com/embed/" + c + "?badge=0&autoplay=1&html5=1" + d, e, f, b)
                }
            }, {
                key: "_showVimeoVideo",
                value: function(a, b) {
                ...
                value: function(a, b) {
                    ...
                    var e = this._$element.data("width") || 560
                      , f = this._$element.data("height") || e / (560 / 315);
                    return b.html('<div class="embed-responsive embed-responsive-16by9"><' + d + ' width="' + e + '" height="' + f + '" preload="auto" autoplay controls class="embed-responsive-item"><source src="' + a + '" type="' + c + '">' + this._config.strings.type + "</" + d + "></div>"),
                    this._resize(e, f),
                    this._config.onContentLoaded.call(this),
                    this._$modalArrows && this._$modalArrows.css("display", "none"),
                    this._toggleLoading(!1),
