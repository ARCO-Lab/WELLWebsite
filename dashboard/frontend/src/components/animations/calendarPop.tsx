...
import { Button, buttonVariants } from "@/components/animations/button"
    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) aria-disabled:opacity-70 p-0 select-none cursor-pointer",
        ...
        disabled: cn(
          "opacity-70 aria-disabled:opacity-50 cursor-not-allowed",
